...
appRouter.get('/it-news/day', serviceITNews.handleRank('day'))
appRouter.get('/it-news/week', serviceITNews.handleRank('week'))
appRouter.get('/it-news/month', serviceITNews.handleRank('month'))
